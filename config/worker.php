 ...
 * - configurable process/control paths are application-root-relative runtime paths;
 ...
 * - path defaults MUST remain application-root-relative and MUST NOT contain
 *   absolute path syntax, host-specific path fragments, or
 *   repository-topology-dependent paths;
...
return [
     ...
     *
     * This path is application-root-relative and is used only when the resolved
     ...
     *
     * The default path is application-root-relative and targets the normal Composer
     * installation layout.
     *
     ...
     *
     * This path is application-root-relative.
     *
