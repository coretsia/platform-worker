 ...
 *
 * It exposes Worker module metadata and the provider list without owning
 * runtime discovery or manifest construction, and without performing
 * filesystem scanning, container construction, config loading, process
 * spawning, socket/control-channel setup, state-file writes, task
