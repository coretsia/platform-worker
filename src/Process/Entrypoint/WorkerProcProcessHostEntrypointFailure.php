...
/**
 * Package-internal ProcHost runtime/protocol failure.
 *
 * The safe reason belongs to the private ProcHost wire protocol. This failure
 * is not part of the package-level WorkerException taxonomy.
 *
 * @internal
 */
final class WorkerProcProcessHostEntrypointFailure extends \RuntimeException
{
