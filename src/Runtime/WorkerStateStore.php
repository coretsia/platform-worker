...
final readonly class WorkerStateStore
{
    public function __construct(
        ...
        if ($applicationRoot === '' || \str_contains($applicationRoot, "\0")) {
     ...
     *
     * `$applicationRoot` is used only for filesystem path resolution. It is never
    ...
    {
        return \rtrim(\str_replace('\\', '/', $this->applicationRoot), '/') . '/' . $spec->statePath();
    }
}
