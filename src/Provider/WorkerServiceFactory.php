...
final class WorkerServiceFactory
{
    ...
    public function workerStateStore(
        ...
        return new WorkerStateStore($runtimePaths->applicationRoot());
    }
    ...
    {
        return new WorkerLifecycleLock($runtimePaths->applicationRoot());
    }

    public function workerStopSignal(RuntimePathContext $runtimePaths): WorkerStopSignal
    {
        return new WorkerStopSignal($runtimePaths->applicationRoot());
    }

    public function workerControlTransport(RuntimePathContext $runtimePaths): WorkerControlTransport
    {
        return new WorkerControlTransport($runtimePaths->applicationRoot());
    }
    ...
    public function workerProcessGuardianClient(
        ...
        return new WorkerProcessGuardianClient(
            ...
            bootstrapWorkingDirectory: $runtimePaths->applicationRoot(),
            applicationRoot: $runtimePaths->applicationRoot(),
            protocol: $protocol,
