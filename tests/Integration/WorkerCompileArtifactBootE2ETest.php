...
final class WorkerCompileArtifactBootE2ETest extends PackageTestCase
{
    ...
    {
        $applicationRoot = $this->temporaryDirectory('worker-artifact-e2e-application');
        ...
        $foundationPackageRoot = $repoRoot . '/packages/core/foundation';
        $kernelPackageRoot = $repoRoot . '/packages/core/kernel';
        ...
        $presetPath = $applicationRoot . '/config/modes/worker-artifact-e2e.php';
        ...
        self::assertFileDoesNotExist($applicationRoot . '/config/roots.php');
        ...
        $currentGeneration = WorkerArtifactPipelineTestSupport::currentGeneration($applicationRoot);
        ...
        self::removePath($applicationRoot . '/config');
        ...
        $container = new ArtifactRuntimeBooter()->boot(
            new ArtifactRuntimeInput(
                applicationRoot: $applicationRoot,
                artifactRoot: WorkerArtifactPipelineTestSupport::artifactRoot($applicationRoot),
            ),
        );
        ...
        self::assertSame(
            self::normalizedPath($applicationRoot),
            $runtimePaths->applicationRoot(),
        );
        self::assertSame(
            self::normalizedPath(
                WorkerArtifactPipelineTestSupport::artifactRoot($applicationRoot),
            ),
