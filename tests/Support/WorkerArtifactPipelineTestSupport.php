...
final class WorkerArtifactPipelineTestSupport
{
    ...
    public static function artifactRoot(string $applicationRoot): string
    {
        return \rtrim(\str_replace('\\', '/', $applicationRoot), '/')
            . '/'
    ...
    public static function currentGeneration(string $applicationRoot): ArtifactGeneration
    {
        ...
        )->locate(self::artifactRoot($applicationRoot));
    ...
    public static function artifactPayload(
        ...
        $generation = self::currentGeneration($applicationRoot);
        $path = match ($basename) {
    ...
    private static function configKernel(array $kernelConfig): ConfigKernel
    {
        ...
        return new ConfigKernel(
            ...
            applicationLoader: new ApplicationConfigLoader($directiveProcessor),
