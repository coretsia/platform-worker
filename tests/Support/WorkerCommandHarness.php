...
final class WorkerCommandHarness
{
    ...
    public function __construct(
        ...
        $this->configPath = $applicationRoot . '/worker-test-config.json';
        $this->behaviorPath = $applicationRoot . '/worker-test-behavior.json';
    ...
    {
        $path = $this->applicationRoot . '/var/tmp/worker-pids.jsonl';
    ...
    {
        return $this->applicationRoot . '/var/tmp/worker.state.json';
    }

    public function stopPath(): string
    {
        return $this->applicationRoot . '/var/tmp/worker.stop';
    }
    ...
    {
        return $this->applicationRoot . '/var/tmp/worker.sock';
    }
    ...
    {
        $directory = $this->applicationRoot . '/var/tmp';
